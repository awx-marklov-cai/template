...
class AbstractLogger extends ts_base_1.Disposable {
    constructor() {
        super(...arguments);
        this.level = exports.DEFAULT_LOG_LEVEL;
        this._onDidChangeLogLevel = this._register(new ts_base_1.Emitter());
...
class ConsoleMainLogger extends AbstractLogger {
    constructor(logLevel = exports.DEFAULT_LOG_LEVEL) {
        ...
        this.useColors = !ts_base_1.isWindows;
    }
    trace(message, ...args) {
...
class AdapterLogger extends AbstractLogger {
    ...
    extractMessage(msg) {
        ...
        return (0, ts_base_1.toErrorMessage)(msg, this.getLevel() <= LogLevel.Trace);
    }
    dispose() {
        // noop
    }
...
class LogService extends ts_base_1.Disposable {
    constructor(logger) {
        super();
        this.logger = logger;
...
class AbstractLoggerService extends ts_base_1.Disposable {
...
class NullLogService {
    constructor() {
        this.onDidChangeLogLevel = new ts_base_1.Emitter().event;
    }
    setLevel(level) { }
    getLevel() {
