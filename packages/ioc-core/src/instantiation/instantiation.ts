...
export namespace _util {
	export const servicesIds = new Map<string, ServiceIdentifier<any>>();
...
function storeServiceDependency(id: Function, target: Object, index: number, optional: boolean): void {
...
export function createDecorator<T>(serviceId: string): ServiceIdentifier<T> {
	...
	const id = <any>function (target: Object, propertyKey: string | symbol, parameterIndex: number): any {
