import { createDecorator as createServiceDecorator } from '@/instantiation/instantiation';
import { Disposable, Emitter, Event, IDisposable, URI, isWindows, toErrorMessage } from 'ts-base';
