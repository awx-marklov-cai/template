...
import { createDecorator, IInstantiationService, optional, ServicesAccessor } from '@/instantiation/instantiation';
...
describe('Instantiation Service', () => {
	...
	test('service dependent on instantiation service and recursive call', () => {
		...
		const insta = new InstantiationService(
			new ServiceCollection([Service1, new SyncDescriptor(Service1Impl)], [Service2, new SyncDescriptor(Service2Impl)], [Service21, new SyncDescriptor(Service21Impl)]),
		);
