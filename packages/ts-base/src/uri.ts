...
export class URI implements UriComponents {
	...
	static appendParams(url: string, params: Record<string, any> | string): string {
	...
	private static _appendParamsInBrowser(uri: URI, params: Record<string, any> | string): string {
	...
	private static _appendParamsInCommon(uri: URI, params: Record<string, any> | string): string {
		const paramList = [];
