...
function trivia4and5(targetPath, pattern, matchPathEnds) {
    ...
    const parsedPattern = matchPathEnds
        ...
        : function (testPath, basename) {
            return typeof testPath === 'string' && (testPath === nativePath || (!usingPosixSep && testPath === targetPath))
                ? pattern
                : null;
        };
    ...
    if (value) {
        ...
        if (typeof when === 'string') {
            const result = (path, basename, name, hasSibling) => {
                ...
                return (0, async_1.isThenable)(matched) ? matched.then((m) => (m ? pattern : null)) : matched ? pattern : null;
            };
